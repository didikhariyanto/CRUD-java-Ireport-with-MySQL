...
public class FORMEmployees extends javax.swing.JDialog {
    ...
    private void btnPrintAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintAllActionPerformed
         //DBUtilities connection = new DBUtilities();
        
        DBUtilities connection = null;
        try {
            connection = new DBUtilities();
        } catch (SQLException ex) {
            Logger.getLogger(FORMEmployees.class.getName()).log(Level.SEVERE, null, ex);
        }
        java.io.File namaFile=new java.io.File("src/employees/report1.jasper");
        try {
            ...
            jp=net.sf.jasperreports.engine.JasperFillManager.fillReport(jasper, null,connection.getConnection());
